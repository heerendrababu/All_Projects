...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response.toString(4)); // Pretty print JSON
    }
    ...
    public ResponseEntity<String> handleIllegalArgumentException(IllegalArgumentException e) {
        ...
        String description = "Invalid input"; // Default message
        String message = "Invalid input provided."; // Default message

        // Check for specific error messages and adjust accordingly
        ...
        // Put the relevant values into the JSONObject
